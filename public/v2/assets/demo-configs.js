...
var demos = [
  {
    name: 'Lưới',
    description: 'Một lưới vuông với khoảng cách đều giữa các điểm. ' +
        'Hãy thử hội tụ ở các kích thước khác nhau.',
    options: [
      {
        name: 'Số điểm mỗi cạnh',
  ...
  {
    name: 'Hai cụm',
    description: 'Hai cụm có số điểm bằng nhau.',
    options: [
      {
        name: 'Số điểm mỗi cụm',
  ...
  {
    name: 'Ba cụm',
    description: 'Ba cụm có số điểm bằng nhau, nhưng ở ' +
         'các khoảng cách khác nhau. Khoảng cách giữa cụm ' +
         'chỉ hiện rõ ở một số perplexity nhất định',
    options: [
      {
        name: 'Số điểm mỗi cụm',
        min: 1, max: 100, start: 50,
  ...
  {
    name: 'Hai cụm kích thước khác nhau',
    description: 'Hai cụm có số điểm bằng nhau, nhưng phương sai ' +
        'bên trong cụm khác nhau. Độ tách cụm phụ thuộc vào perplexity.',
    options: [
      {
        name: 'Số điểm mỗi cụm',
        min: 1, max: 100, start: 50,
  ...
  {
    name: 'Hai cụm tuyến tính dài',
    description: 'Hai tập điểm được sắp thành các đường song song ' +
        'gần nhau. Hãy chú ý độ cong của các đường.',
    options: [
      {
        name: 'Số điểm mỗi cụm',
        min: 1, max: 100, start: 50,
  ...
  {
    name: 'Cụm trong cụm',
    description: 'Một cụm dày, chặt nằm bên trong một cụm rộng và thưa. ' +
      'Perplexity tạo ra khác biệt lớn ở đây.',
    options: [
      {
        name: 'Số điểm mỗi cụm',
        min: 1, max: 100, start: 50,
  ...
  {
    name: 'Vòng tròn (cách đều)',
    description: 'Các điểm phân bố đều trên một vòng tròn. ' +
        'Sắc độ tương ứng với góc trên vòng tròn.',
    options: [
      {
        name: 'Số điểm',
        min: 1, max: 100, start: 50,
  ...
  {
    name: 'Các bước trực giao',
    description: 'Các điểm liên hệ với nhau bằng các bước trực giao. ' +
      'Rất giống một bước đi ngẫu nhiên.',
    options: [
      {
        name: 'Số điểm',
        min: 1, max: 500, start: 50,
  ...
  {
    name: 'Bước đi ngẫu nhiên',
    description: 'Bước đi ngẫu nhiên Gaussian. ' +
      'Mượt hơn bạn có thể nghĩ.',
      options: [{
        name: 'Số điểm',
  ...
  {
    name: 'Nhảy ngẫu nhiên',
    description: 'Nhảy ngẫu nhiên Gaussian',
    options: [
      {
        name: 'Số điểm',
        min: 1, max: 1000, start: 100,
  ...
  {
    name: 'Cách đều',
    description: 'Một tập điểm trong đó khoảng cách giữa mọi cặp ' +
        'điểm đều bằng nhau trong không gian gốc.',
    options: [
      {
        name: 'Số điểm',
